    ...
    <div class="flex flex-col items-center mt-20 px-6 py-4 mx-auto md:h-screen lg:py-2">
        <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('dashboard') }}">
                    @csrf
                    <div>
                        <label for="refer_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Referrer Name</label>
                        <input type="text" name="refer_name" id="refer_name" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                    </div>

                    <div>
                        <label for="refer_number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Referrer Number</label>
                        <input type="number" name="refer_number" id="refer_number" class="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                    </div>
