<nav class="bg-white border-gray-200 dark:bg-gray-900">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    <a href="{{route('personal-information')}}" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="{{asset('images/sumeru_logo.png')}}" class="h-12" alt="Sumeru Logo" />
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Sumeru Securities</span>
    </a>
        ...
        <li>
          @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="block py-2 px-3 text-white bg-red-700 rounded md:bg-transparent md:text-red-700 md:p-0 dark:text-white md:dark:text-red-700">Log in</a>
